...
export default class MemConfigs extends React.Component {
  ...
  showCreate = () => {
    ...
    return this.props.trigger('memconfig.create', {
      module: 'configmaps',
  ...
  render() {
    ...
    // 过滤数据源，只保留包含memory.profile的configmap
    const filteredTableProps = {
      ...tableProps,
      data: tableProps.data.filter(item => 
        Object.keys(item.data || {}).some(key => key.includes('memory.profile'))
      ),
    }
